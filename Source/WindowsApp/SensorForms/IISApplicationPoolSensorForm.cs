...
namespace MonitoR.Configurator.SensorForms
{
    public partial class IISApplicationPoolSensorForm : Form
    {
        ...
        public IISApplicationPoolSensor Sensor { get; }
        ...
        public void UpdateDataFromUI()
        {
            ...
            Sensor.ApplicationPools.Clear();

            for (int i = 0; i < cklbDrives.Items.Count; ++i)
            {
                if (!cklbDrives.GetItemChecked(i))
                    continue;
                Sensor.ApplicationPools.Add(cklbDrives.Items[i].ToString());
            }
        }
        ...
        public void UpdateUIFromData()
        {
            ...
            foreach (var dr in Sensor.ApplicationPools)
            {
                for (int i = 0; i < cklbDrives.Items.Count; ++i)
                {
